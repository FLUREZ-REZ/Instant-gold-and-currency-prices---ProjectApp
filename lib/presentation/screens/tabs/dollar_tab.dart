...
class dollartab extends StatefulWidget {
  const dollartab({super.key});

  @override
  State<dollartab> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<dollartab> {
